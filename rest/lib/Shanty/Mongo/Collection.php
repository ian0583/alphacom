...
abstract class Shanty_Mongo_Collection
{
	...
	public static function getCollectionRequirements($inherited = true)
	{
		...
		if (! $inherited || $calledClass === __CLASS__)
		{
			...
			if ($reflector->getDeclaringClass ()->getName () !== $calledClass)
				return array ();
	...
	/*
	 * Get a connection @param $writable should the connection be writable @return Shanty_Mongo_Connection
	 */
