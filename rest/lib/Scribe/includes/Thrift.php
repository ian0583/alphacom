 ...
 * WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License. @package thrift
 */
 ...
 *
 * @param $p1 mixed
 *       	 Message (string) or type-spec (array)
 * @param $p2 mixed
 *       	 Code (integer) or values (array)
 */
...
/**
 * Base class from which other Thrift structs extend.
