/*
 * --- name: Picker.Date.Range description: Select a Range of Dates authors:
 * Arian Stolwijk requires: [Picker, Picker.Date] provides: Picker.Date.Range
 * ...
 */
...
Picker.Date.Range = new Class(
	...
	constructPicker : function()
	{
		...
		var events =
			...
			blur : function()
			{
				...
				if ( date.isValid )
					self[ ( this == startInput ? 'start' : 'end' ) + 'Date' ] = date;
	...
	selectRange : function()
	{
		...
		var dates =
			[ this.startDate, this.endDate ], input = this.input;
