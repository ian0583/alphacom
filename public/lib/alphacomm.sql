...
--
-- Host: localhost
-- Generation Time: Apr 28, 2012 at 07:50 AM
...
CREATE TABLE IF NOT EXISTS `countries` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=258 ;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `confirm` varchar(100) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `password`, `confirm`, `status`) VALUES
(1, 'admin', 'password1234', '', 1);
