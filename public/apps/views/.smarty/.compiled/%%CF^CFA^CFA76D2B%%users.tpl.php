<?php /* Smarty version 2.6.25, created on 2012-05-06 12:57:14
         compiled from D:%5Cwww%5Calphacom/apps/views/main/users.tpl */ ?>
<div id="users">
	<div id="listings">
...
?>
							<tr onclick="location.href='users-edit/<?php echo $this->_tpl_vars['users'][$this->_sections['x']['index']]['id']; ?>
...
users/<?php echo $this->_tpl_vars['previous']; ?>
...
">Previous</a>
					...
					<div class="next">
						<a href="<?php echo @APP_URI; ?>
users/<?php echo $this->_tpl_vars['next']; ?>
/<?php echo $this->_tpl_vars['searchterm']; ?>
">Next</a>
					</div>
					<?php endif; ?>
