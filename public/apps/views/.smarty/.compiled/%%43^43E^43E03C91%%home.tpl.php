<?php /* Smarty version 2.6.25, created on 2012-05-02 17:37:25
         compiled from D:%5Cwww%5Calphacom/apps/views/main/home.tpl */ ?>
<div id="homepage">
	<div class="row-fluid">
		<div class="span4 boxed" id="profiles">
			...
			<div class="text_center">
				<img alt="" src="<?php echo @APP_INCLUDES; ?>
img/database.png">
				<img alt="" src="<?php echo @APP_INCLUDES; ?>
img/search_user.png">
			</div>
		...
		<div class="span4 boxed" id="profiles-edit">
			...
			<div class="text_center">
				<img alt="" src="<?php echo @APP_INCLUDES; ?>
img/add_male_user.png">
				<img alt="" src="<?php echo @APP_INCLUDES; ?>
img/add_female_user.png">
			</div>
		</div>
